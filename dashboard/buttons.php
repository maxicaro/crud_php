...
$consulta = "SELECT user_id, username, first_name, last_name, gender, password, status, FROM especialistas";
        ...
        <form id="formUsuarios">    
            <div class="modal-body">
                <div class="row">
                    ...
                    <label for="" class="col-form-label"><strong>Especialista</strong></label>
                ...
                <div class="row"> 
                    ...
                    <div class="col-lg-6">
                    <div class="form-group">
                    <label for="" class="col-form-label"><strong>Genero</strong></label>
...
<?php require_once "vistas/vista_especia.php"?>
